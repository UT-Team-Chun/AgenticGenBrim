...
192件の設計生成実験により，RAG活用時の初回合格率が37.5\%，修正ループ適用後の最終収束率が85.4\%であることを確認した．
