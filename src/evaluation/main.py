...
DEFAULT_EVALUATION_CASES: list[EvaluationCase] = [
    EvaluationCase(case_id="L30_B6", bridge_length_m=30, total_width_m=6),
    ...
    EvaluationCase(case_id="L40_B12", bridge_length_m=40, total_width_m=12),
    EvaluationCase(case_id="L50_B6", bridge_length_m=50, total_width_m=6),
    EvaluationCase(case_id="L50_B10", bridge_length_m=50, total_width_m=10),
    EvaluationCase(case_id="L50_B14", bridge_length_m=50, total_width_m=14),
    EvaluationCase(case_id="L60_B10", bridge_length_m=60, total_width_m=10),
    EvaluationCase(case_id="L60_B14", bridge_length_m=60, total_width_m=14),
    EvaluationCase(case_id="L70_B10", bridge_length_m=70, total_width_m=10),
    EvaluationCase(case_id="L70_B14", bridge_length_m=70, total_width_m=14),
]
