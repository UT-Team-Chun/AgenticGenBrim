...
\pagestyle{fancy}
\fancyhf{}
\lhead{鋼プレートガーダー橋 BrIM 生成エージェントシステム}
\rhead{\leftmark}
\cfoot{\thepage}
...
\section{第4章 Designer（設計生成）サブシステム}
...
【生成された設計値】（design\_L50\_B10\_20260106\_163611.json）
...
生成された IFC ファイル（design\_L50\_B10\_20260106\_163611.ifc）には以下の 3D 要素が含まれる：
...
\section{付録 A: 主要 Pydantic モデル一覧}
